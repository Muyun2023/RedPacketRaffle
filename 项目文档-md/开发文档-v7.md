...
- 代码在【课程包/文档】目录下的  lottery.zip中，解压到笔记本的某个目录

  （注意，该目录的全路径上只能使用英文字母和数字，禁止出现中文、特殊字符、空格等）

- 在解压后的lottery目录下打开命令行，建议使用git创建新分支（非必须）：
...
《缓存预热设计》相关视频: https://pan.baidu.com/s/1Mu5yLP5jZH75r8ZBh6Z8WQ?pwd=mw55 
...
《抽奖业务设计》相关视频: https://pan.baidu.com/s/1EQFu9q--k2VkanjhPZaiNg?pwd=93ar 
